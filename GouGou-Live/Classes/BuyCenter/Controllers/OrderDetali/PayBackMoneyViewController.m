...
- (void)getBackMoneyRequest {
    ...
    [self getRequestWithPath:API_Order_limit params:dict success:^(id successJson) {
        ...
        self.orderStateView.stateMessage = @"待付尾款";
...
- (BottomButtonView *)bottomButton {
    ...
    if (!_bottomButton) {
        _bottomButton = [[BottomButtonView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 44) title:@[@"申请维权",@"不想买了",@"联系卖家",@"支付尾款"]];
