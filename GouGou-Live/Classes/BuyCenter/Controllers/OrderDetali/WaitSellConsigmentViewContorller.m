...
@property(nonatomic, strong) OrderDetailModel *orderInfo; /**< 模型 */
...
#pragma mark
#pragma mark - 网络请求
- (void)getSellerConsigmentRequest {
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    [self getSellerConsigmentRequest];
}
- (void)viewDidLoad {
    [super viewDidLoad];
    ...
    if (!_bottomButton) {
        ...
        _bottomButton.difFuncBlock = ^ (UIButton *button) {
            ...
            if ([button.titleLabel.text isEqual:@"申请维权"]) {
                ...
                [weakself clickConsignment:weakself.orderInfo.ID];
            }
        };
    }
