...
#import "SureForgetPayViewController.h"
#import "NSString+MD5Code.h"
#import "SetPayPsdSuccessViewController.h"

@interface SureForgetPayViewController ()<UITextFieldDelegate>

@property (weak, nonatomic) IBOutlet UITextField *psdTextField;
@property (weak, nonatomic) IBOutlet UITextField *surePsdTextField;
@end

@implementation SureForgetPayViewController
- (void)surePsdRequest {
    ...
    [self postRequestWithPath:API_Pay_find params:dict success:^(id successJson) {
        DLog(@"%@", successJson);
