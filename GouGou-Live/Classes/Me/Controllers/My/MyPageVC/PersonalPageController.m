    ...
    switch (indexPath.section) {
        ...
        case 1:
            if (indexPath.row == 0) { // 简介
                ...
                simpleLabel.text = @"简介";
                simpleLabel.frame = CGRectMake(10, 10, 40, 20);
                simpleLabel.font = [UIFont systemFontOfSize:16];
                simpleLabel.textColor = [UIColor colorWithHexString:@"#333333"];
                [cell.contentView addSubview:simpleLabel];
                
                UILabel * simpleTitle = [[UILabel alloc] init];
                simpleTitle.text = @"我的简介";
                simpleTitle.frame = CGRectMake(10, 40, SCREEN_WIDTH - 20, 20);
                simpleTitle.font = [UIFont systemFontOfSize:14];
                simpleTitle.textColor = [UIColor colorWithHexString:@"#666666"];
                [cell.contentView addSubview:simpleTitle];
