...
@implementation SellerWaitRateCell
...
- (void)setModel:(SellerOrderModel *)model {
    ...
    self.dogCardView.oldPriceLabel.attributedText = [self getCenterLineWithString:model.priceOld];
