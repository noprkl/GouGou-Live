...
@interface AddDogImpressionView ()<UITextFieldDelegate>
...
@implementation AddDogImpressionView
...
#pragma mark
#pragma mark - 约束
- (void)setDogImpress:(NSString *)dogImpress {
    _dogImpress = dogImpress;
    self.searchTextfiled.text = dogImpress;
}
- (void)layoutSubviews {
