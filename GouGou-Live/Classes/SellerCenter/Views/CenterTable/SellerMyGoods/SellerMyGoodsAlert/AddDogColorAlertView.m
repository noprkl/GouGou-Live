...
#import "AddDogColorAlertView.h"

@interface AddDogColorAlertView () <UIPickerViewDataSource, UIPickerViewDelegate>
...
@implementation AddDogColorAlertView
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component {
    ...
    self.colorString = self.dataPlist[row];
