...
@interface SellerDeleDDetailView ()
...
@implementation SellerDeleDDetailView
...
- (void)layoutSubviews {
    ...
    [_countLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(weakself.top).offset(25);
    }];
    
    [_sureDeleteLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.equalTo(weakself.centerX);
        make.top.equalTo(weakself.countLabel.bottom).offset(5);
